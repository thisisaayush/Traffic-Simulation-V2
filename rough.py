...
class Intersections:
    ...
    def find_intersections(self, *roads): # returns the list of tuple of all intersected coordinates of a map.
...
#
# x = Intersections()
# print(x.find_intersections(road1, road2, road3, road4, road5, road6, highway1, highway2))
